...
class Twenty8teen_Customize_Preset_Control extends WP_Customize_Control {
	...
	public function enqueue() {
      ...
      '/css/customize-preset.css', array(), '20180416' );
...
/**
	...
	public function render_preset_content( $preset ) {
		...
		if ( is_array( $values ) && count( $values ) ) {
			...
			<div data-preset="<?php echo $esc_preset; ?>" class="preset-item accordion-section">
				<h4 class="accordion-section-title" role="presentation">
					<?php echo esc_html( empty( $this->choices[$preset] ) ? $preset : $this->choices[$preset] ); ?>
				</h4>
				<div  class="accordion-section-content submitbox">
					<?php if ( $keys ) : ?>
	...
	public function render_content() {
		...
		<div id="customize-control-preset" class="customize-preset accordion-container">
